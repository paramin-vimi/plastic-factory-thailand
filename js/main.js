(() => {
  ...
  const IMAGES = {
    'hero':       A + 'exterior.webp',
    'factory':    A + 'factory.webp',
    'cnc':        A + 'cnc.webp',
    'cleanroom':  A + 'cleanroom.webp',
    'fac-1':      A + 'fac-prachinburi.webp',
    'fac-2':      A + 'fac-rayong.webp'
  };
  ...
  function init() {
    ...
    initHero(); initCounters(); initForm(); initFactoryTour(); initMap(); initTop();
